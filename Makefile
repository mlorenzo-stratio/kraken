...
CROSS_COMPILER = docker run --rm -t -v $(GOBUILD):/go -v $(GOPATH):/go/src/github.com/uber/kraken -e GO111MODULE=on -w /go/src/github.com/uber/kraken golang:1.11.4 go build -o ./$@ ./$(dir $@)
